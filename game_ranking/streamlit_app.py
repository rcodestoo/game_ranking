...
with tab_steam:
    ...
    with st.expander("🔍 Filters", expanded=True):
        ...
        with f_col1:
            ...
            start_date = st.date_input("From", value=default_start, key="steam_start_date")
            end_date   = st.date_input("To",   value=default_end, key="steam_end_date")
...
with tab_nonsteam:
    ...
    with st.expander("🔍 Filters", expanded=True):
        ...
        with nf_col1:
            ...
            ns_start = st.date_input("From", value=default_ns_start, key="ns_start_date")
            ns_end   = st.date_input("To",   value=default_ns_end, key="ns_end_date")
...
with tab_inventory:
    ...
    with st.expander("🔍 Filters", expanded=True):
        ...
        with inv_f1:
            ...
            inv_start = st.date_input("From", value=default_inv_start, key="inv_start_date")
            inv_end   = st.date_input("To",   value=default_inv_end, key="inv_end_date")
